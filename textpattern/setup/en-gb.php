...
$en_gb_lang = array(
	'admin' => array(
		...
		'password_reset_confirmation_request_sent' => 'A confirmation message was sent to your e-mail address. Please check your e-mail and follow the instructions.',
	...
	'common' => array(
		...
		'get_off_my_lawn' => 'I&#8217;m sorry. I&#8217;m afraid I can&#8217;t do that. I think <code>{event}</code> <code>{step}</code> is no safe operation at this time.',
		'gl-gz' => 'Galego',
		'greeting' => 'Dear',
		'he-il' => 'עברית',
		'hidden' => 'Hidden',
...
',
	...
	'prefs' => array(
		...
		'comment_nofollow' => 'Apply <code>rel="nofollow"</code> to comments?',
		...
		'new_textpattern_version_available' => 'There is a completely new Textpattern version available. Do you want to <a href="http://textpattern.com/download">try it</a>?',
		'norwegian' => 'Norwegian',
		...
		'title_only' => '/title',
		'updated' => 'Updated',
		'updated_branch_version_available' => 'There is an update for this Textpattern version series available. Do you want to <a href="http://textpattern.com/download" rel="external">try it</a>?',
	...
	'public' => array(
		...
		'invalid_attribute_value' => '{name} is not a valid attribute value',
		'keywords' => 'Keywords',
		'label' => 'Label',
	...
	'setup' => array(
		...
		'prefix_bad_characters' => 'The table prefix {dbprefix} contains characters that are not allowed.<br />The first character must match one of <strong>a-zA-Z_</strong> and all following characters must match one of <strong>a-zA-Z0-9_</strong>',
		...
		'warn_mail_unavailable' => 'Your PHP installation is missing the mail() function. Therefore no e-mails can be sent from Textpattern, which limits certain functionality.',
...
$lastmod = gmdate('Y-m-d H:m:s',1308376007);
?>