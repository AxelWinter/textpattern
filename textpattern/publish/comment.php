...
$HeadURL: http://textpattern.googlecode.com/svn/development/4.x/textpattern/publish/comment.php $
$LastChangedRevision: 3632 $
...
// -------------------------------------------------------------
	...
	function commentForm($id, $atts=NULL)
	{
		...
		$vals = array(
			...
			'comment_web_input'			=> fInput($h5 ? 'url' : 'text', 'web', htmlspecialchars($web)	, 'comment_web_input', '', '', $isize, '', 'web', false, false),
